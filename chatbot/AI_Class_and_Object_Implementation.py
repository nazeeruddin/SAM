...
class Email_AI:
    ...
    def __init__(self):
        ...
        with open('./chatbot/Data/my_dumped_classifier.pkl', 'rb') as fid:
            self.clf = cPickle.load(fid)

        with open('./chatbot/Data/my_dumped_idf.pkl', 'rb') as fid:
            self.idf = cPickle.load(fid)

        with open('./chatbot/Data/my_dumped_data.pkl', 'rb') as fid:
            self.vector = cPickle.load(fid)

        with open('./chatbot/Data/my_dumped_y.pkl', 'rb') as fid:
